...
public class UserService {
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        return new LoginResponse(token, role,"로그인 성공", user.getUserId(), user.getEmail());
    ...
    public LoginResponse kakaoLogin(String code) {
        ...
        String token = JwtTokenProvider.createToken(user.getUserId(), user.getRole().name());
        return new LoginResponse(token, user.getRole().name(), "카카오 로그인 성공", user.getUserId(), email);
    }
